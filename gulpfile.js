...
gulp.task('audio:build', function () {
  return gulp.src(path.src.audio)
    .pipe(gulp.dest(path.build.dirDev + 'audio/'))
    .pipe(bs.reload({
      stream: true
    }));
});
...
gulp.task('watch:build', function () {
  ...
  gulp.watch(path.src.audio, gulp.series('audio:build'));
...
// audio
gulp.task('audio:free:build', function () {
  return gulp.src(path.src.audio)
    .pipe(gulp.dest(path.build.dirFree + 'audio/'))
});
...
// audio
gulp.task('audio:premium:build', function () {
  return gulp.src(path.src.audio)
    .pipe(gulp.dest(path.build.dirPremium + 'audio/'));
});
...
// audio
gulp.task('audio:netlify:build', function () {
  return gulp.src(path.src.audio)
    .pipe(gulp.dest(path.build.dirNetlify + 'audio/'));
});
